...
if not exist %PREFIX%\opt\zowe\plugins\app-server\%PKG_NAME%\%PKG_VERSION% mkdir %PREFIX%\opt\zowe\plugins\app-server\%PKG_NAME%\%PKG_VERSION%
robocopy %SRC_DIR% %PREFIX%\opt\zowe\plugins\app-server\%PKG_NAME%\%PKG_VERSION% * /E > nul
